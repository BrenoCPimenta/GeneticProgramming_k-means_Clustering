...
def FitnessCLustering(k, X, Y, euclidean=True, subject=None):
    ...
    if euclidean:# cria instância do K-Means utilizando distância Euclidiana
        ...
        subject_metric = distance_metric(type_metric.USER_DEFINED, func=subject_function)
        kmeans_instance = kmeans(X, initial_centers, metric=subject_metric)
